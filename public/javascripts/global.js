...
$(document).ready(function() {
    ...
    $('#userList table tbody').on('click', 'td a.linkshowuser', populateUpdateField);
...
// Populate the update field
function populateUpdateField(event) {
    event.preventDefault();
    ...
    // Change the form update url to include the this entry ID
    $('#immutableUserID').val(thisUserObject._id);
};
...
function updateUser(event) {
    ...
    if(errorCount === 0) {
        ...
        // If it is, compile all user info into one object
        var updatedUser = {
            '_id': $('#updateUser fieldset input#immutableUserID').val(),
